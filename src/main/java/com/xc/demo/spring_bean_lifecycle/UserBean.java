...
public class UserBean implements InitializingBean,
        BeanNameAware,
        DisposableBean, MergedBeanDefinitionPostProcessor,
    ...
    public void setBeanName(String name) {
        System.out.println("6. 调用 BeanNameAware.setBeanName() 方法      "+ name);
    }
    ...
    public void postProcessMergedBeanDefinition(RootBeanDefinition beanDefinition, Class<?> beanType, String beanName) {
        System.out.println("11. 调用 MergedBeanDefinitionPostProcessor.postProcessMergedBeanDefinition() 方法");
    }
